...
for(cou in 1:19){
  ...
  if(cou==1){write.csv(ou, file = "D300.csv")}
  if(cou==2){write.csv(ou, file = "D500.csv")}
  if(cou==3){write.csv(ou, file = "D800.csv")}
  if(cou==4){write.csv(ou, file = "D1000.csv")}  
  if(cou==5){write.csv(ou, file = "D1500.csv")}
  if(cou==6){write.csv(ou, file = "D2000.csv")}
  if(cou==7){write.csv(ou, file = "D3000.csv")}
  if(cou==8){write.csv(ou, file = "D4000.csv")}
  if(cou==9){write.csv(ou, file = "D5000.csv")}
  if(cou==10){write.csv(ou, file = "D6000.csv")}
  if(cou==11){write.csv(ou, file = "D7000.csv")}
  if(cou==12){write.csv(ou, file = "D10000.csv")}
  if(cou==13){write.csv(ou, file = "D12000.csv")}
  if(cou==14){write.csv(ou, file = "D14000.csv")}
  if(cou==15){write.csv(ou, file = "D17000.csv")}
  if(cou==16){write.csv(ou, file = "D20000.csv")}
  if(cou==17){write.csv(ou, file = "D23000.csv")}
  if(cou==18){write.csv(ou, file = "D26000.csv")}
  if(cou==19){write.csv(ou, file = "D30000.csv")}
  print(ou)
