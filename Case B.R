...
for(cou in 1:19){
  ...
  if(cou==1){write.csv(ou, file = "B300.csv")}
  if(cou==2){write.csv(ou, file = "B500.csv")}
  if(cou==3){write.csv(ou, file = "B800.csv")}
  if(cou==4){write.csv(ou, file = "B1000.csv")}  
  if(cou==5){write.csv(ou, file = "B1500.csv")}
  if(cou==6){write.csv(ou, file = "B2000.csv")}
  if(cou==7){write.csv(ou, file = "B3000.csv")}
  if(cou==8){write.csv(ou, file = "B4000.csv")}
  if(cou==9){write.csv(ou, file = "B5000.csv")}
  if(cou==10){write.csv(ou, file = "B6000.csv")}
  if(cou==11){write.csv(ou, file = "B7000.csv")}
  if(cou==12){write.csv(ou, file = "B10000.csv")}
  if(cou==13){write.csv(ou, file = "B12000.csv")}
  if(cou==14){write.csv(ou, file = "B14000.csv")}
  if(cou==15){write.csv(ou, file = "B17000.csv")}
  if(cou==16){write.csv(ou, file = "B20000.csv")}
  if(cou==17){write.csv(ou, file = "B23000.csv")}
  if(cou==18){write.csv(ou, file = "B26000.csv")}
  if(cou==19){write.csv(ou, file = "B30000.csv")}
  print(ou)
