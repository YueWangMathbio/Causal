...
for(cou in 1:19){
  ...
  if(cou==1){write.csv(ou, file = "A300.csv")}
  if(cou==2){write.csv(ou, file = "A500.csv")}
  if(cou==3){write.csv(ou, file = "A800.csv")}
  if(cou==4){write.csv(ou, file = "A1000.csv")}  
  if(cou==5){write.csv(ou, file = "A1500.csv")}
  if(cou==6){write.csv(ou, file = "A2000.csv")}
  if(cou==7){write.csv(ou, file = "A3000.csv")}
  if(cou==8){write.csv(ou, file = "A4000.csv")}
  if(cou==9){write.csv(ou, file = "A5000.csv")}
  if(cou==10){write.csv(ou, file = "A6000.csv")}
  if(cou==11){write.csv(ou, file = "A7000.csv")}
  if(cou==12){write.csv(ou, file = "A10000.csv")}
  if(cou==13){write.csv(ou, file = "A12000.csv")}
  if(cou==14){write.csv(ou, file = "A14000.csv")}
  if(cou==15){write.csv(ou, file = "A17000.csv")}
  if(cou==16){write.csv(ou, file = "A20000.csv")}
  if(cou==17){write.csv(ou, file = "A23000.csv")}
  if(cou==18){write.csv(ou, file = "A26000.csv")}
  if(cou==19){write.csv(ou, file = "A30000.csv")}
  print(ou)
